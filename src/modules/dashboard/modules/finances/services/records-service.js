    ...
    update: (proxy, { data: { createRecord } }) => {
      ...
      try {
        ...
        if (recordDate.isBefore(currentDate)) {
          ...
          console.log('TotalBalanceQuery: ', TotalBalanceQuery)
          console.log('variables: ', variables)

          console.log('totalBalanceData.totalBalance: ', totalBalanceData.totalBalance)
          console.log('createRecord.amount: ', createRecord.amount)
